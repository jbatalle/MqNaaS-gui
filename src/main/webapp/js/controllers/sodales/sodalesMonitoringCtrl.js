...
angular.module('openNaaSApp')
        .controller('SodalesMonitoringController', function ($scope, ngTableParams, $filter, $routeParams, localStorageService, ngDialog, arnService) {
...
//                console.log($scope.data);
            ...
            $scope.viewStatistics = function (interfaceId) {
                ...
                ngDialog.open({
                    ...
                    controller: 'statisticsDialogCtrl',
                    scope: $scope}
                );
            };
